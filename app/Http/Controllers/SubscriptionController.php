    ...
    public function index(Request $request): Response
    {
        ...
        $plans = [
            [
                ...
                'subtitle' => 'Pour tester la plateforme et publier vos premiers articles.',
                'button_text' => 'Commencer Gratuitement',
                'features' => [
                    'Jusqu\'à 10 produits max',
                    'Vitrine sous-domaine BIOLINKO',
                    'Fast Checkout MoMo (MTN & Orange)',
                    '1 variante par produit (Taille/Couleur)',
            ...
            [
                ...
                'subtitle' => 'Pour les vendeurs qui veulent automatiser et personnaliser leur boutique.',
                'button_text' => 'Choisir le Plan Pro',
                'features' => [
                    'Jusqu\'à 50 produits max',
                    'Variantes illimitées & surprix',
                    'Relance WhatsApp 1-Clic paniers',
                    'Factures PDF avec QR Code & Filigrane',
                    'Studio Visuel (Ordre des sections)',
            ...
            [
                ...
                'marketing_pixels' => false,
                'priority_support' => true,
                'subtitle' => 'Pour les boutiques en forte croissance d\'activité.',
                'button_text' => 'Activer le Plan Growth',
                'features' => [
                    'Jusqu\'à 200 produits max',
                    'Toutes les fonctionnalités Pro incluses',
                    'Relances WhatsApp illimitées',
                    'Retraits MoMo prioritaires (< 4h)',
                    'Analytics avancés (Ventes 14j & Top 5)',
            ...
            [
                ...
                'marketing_pixels' => false,
                'priority_support' => true,
                'subtitle' => 'Pour les marques et équipes grands comptes.',
                'button_text' => 'Activer le Plan Business',
                'features' => [
                    'Catalogue Produits ILLIMITÉ',
                    'Toutes les fonctionnalités Growth incluses',
                    'Retraits MoMo en Temps Réel',
                    'Exportation comptable (CSV/Excel)',
