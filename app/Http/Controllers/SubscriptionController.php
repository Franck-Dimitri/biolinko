        ...
        $plans = [
            [
                ...
                'features' => [
                    ...
                    'Capacité de stock : 30 articles max',
            ...
            [
                ...
                'features' => [
                    ...
                    '🚀 Notifications WhatsApp Automatiques Officielles (reçus, factures, suivi en direct)',
                    'Variantes illimitées (Tailles, Couleurs & Surprix)',
                    'Relance WhatsApp automatique des paniers abandonnés',
                    ...
                    'Retraits Mobile Money prioritaires',
                    'Support Vendeur VIP WhatsApp 7j/7',
                ],
            ],
        ];
