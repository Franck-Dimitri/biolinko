...
import { User, Mail, Phone, Lock, Store, ShoppingCart, CreditCard, Package, Truck, Zap, ShoppingBag, Sparkles, ArrowRight, Loader2 } from 'lucide-react';
                        ...
                        <div className="max-w-md mx-auto w-full">
                            ...
                            <form onSubmit={submit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className={`w-full py-3.5 px-6 rounded-xl bg-[#FFCC00] hover:bg-amber-300 active:scale-[0.99] text-slate-950 font-black text-sm shadow-sm transition-all duration-200 flex items-center justify-center gap-2 mt-2 select-none cursor-pointer ${
